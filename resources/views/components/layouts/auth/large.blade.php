...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen antialiased relative overflow-hidden">
        ...
        <div class="relative z-10 flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
            <!-- Large Glass Card for Register -->
            <div class="w-full max-w-4xl backdrop-blur-2xl bg-white/90 dark:bg-neutral-900/90 border border-white/30 dark:border-neutral-700/40 rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/30 p-8 md:p-12">
